...
document.getElementById("cerrar").addEventListener("click", () => {
  ...
  document.getElementById("menu_carta").style.display = "none";
...
document.querySelectorAll(".carta-volteable").forEach((carta) => {
  carta.addEventListener("click", (event) => {
    ...
    fetch('../data/cartas_objetivos.json')
      ...
      .then(data => {
        ...
        titulo_Desc.innerHTML = carta.Objetivo;
        ...
        titulo_Obj.innerHTML = carta.Objetivo;
